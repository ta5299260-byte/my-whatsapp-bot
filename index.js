...
const ownerNumber = '249917687865'; // رقمك الأساسي
    ...
    sock.ev.on('messages.upsert', async (m) => {
        ...
        try {
            ...
            if (isGroup) {
                ...
                // إضافة حقيقية مع معالجة الأخطاء والنتيجة الفعلية من السيرفر
                if (command === '.add') {
                    if (!query) { 
                    ...
                    try {
                        ...
                        // فحص استجابة سيرفر واتساب الحقيقية
